...
class package(Base):
    ...
    type = Column("type", String(1), primary_key=True, index=True)
    description = Column("description", String(150))

class family(Base):
    __tablename__ = "family"
    family_id = Column("family_id", Integer, primary_key=True, index=True)
...
class user(Base):
    ...
    username = Column("username", String(30), primary_key=True, unique=True, index=True)
